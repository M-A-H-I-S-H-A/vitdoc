document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderSidebarHistory(userObj = null) {
        ...
        currentItem.onclick = () => loadSession(currentSessionId, currentSessionMessages);
    ...
    function generateAIResponse(input, hasImage = false) {
        ...
        if (storedUser) {
            ...
            if (user.profileData) {
                ...
                userContext = `*(Personalized Insight based on your profile: Age ${age}, Diet - ${diet}, Medical - ${Array.isArray(conds)?conds.join(', '):conds})*\n\n`;
            }
        }
        
        if (hasImage) {
            return userContext + `I have analyzed the image you uploaded alongside your symptoms. Based on the visual characteristics and context, here are a few possibilities to consider:

**Possibility 1: Iron Deficiency (Anemia)**
- **Why:** The pale appearance in the image, combined with general symptoms, strongly suggests a lack of sufficient red blood cells.
- **Action:** Consider increasing intake of spinach, red meat, and lentils. A blood test checking ferritin levels is highly recommended.

**Possibility 2: Vitamin C Deficiency**
- **Why:** If there are accompanying signs of rough skin or easy bruising (which can sometimes look like paleness), Vitamin C aids in collagen production and iron absorption.
- **Action:** Add citrus fruits, strawberries, and bell peppers to your diet.

**Possibility 3: Poor Circulation / Dehydration**
- **Why:** Sometimes visual symptoms aren't strictly vitamin-related but are due to lack of water or poor blood flow.
- **Action:** Ensure you are drinking at least 8 glasses of water a day.

*Disclaimer: Image analysis is simulated and should be verified by a medical professional.*`;
        }
        
        if (lowercaseInput.includes('tired') || lowercaseInput.includes('fatigue') || lowercaseInput.includes('exhausted')) {
            return userContext + `Fatigue is a complex symptom that can stem from various sources. Based on what you've described, here are multiple potential deficiencies to explore:
            
**Possibility 1: Vitamin B12 Deficiency**
- **Analysis:** B12 is crucial for nerve function and the creation of red blood cells. A lack of it can lead to severe exhaustion and a feeling of faintness.
- **Dietary Sources:** Meat, fish, milk, cheese, and fortified cereals.

**Possibility 2: Vitamin D Deficiency**
- **Analysis:** Very common, especially in winter or for indoor workers. Low Vitamin D is strongly correlated with daytime sleepiness and fatigue.
- **Dietary Sources:** Salmon, egg yolks, and fortified foods (also, try getting 10-15 minutes of sunlight!).

**Possibility 3: Iron Deficiency (Anemia)**
- **Analysis:** Without enough iron, your body can't produce enough hemoglobin, leading to exhaustion and potentially pale skin.
- **Dietary Sources:** Spinach, red meat, lentils, and pumpkin seeds.

Are you experiencing any other symptoms like muscle aches (which might point towards Vitamin D) or tingling in your extremities (pointing to B12)?`;
        }
        
        if (lowercaseInput.includes('muscle') || lowercaseInput.includes('cramp') || lowercaseInput.includes('spasm')) {
            return userContext + `Muscle cramps and spasms are generally linked to electrolyte imbalances. Here is a multi-diagnosis breakdown:

**Possibility 1: Magnesium Deficiency**
- **Analysis:** Magnesium is nature's "relaxant" mineral. A lack of it causes muscles to remain contracted, leading to spasms.
- **Dietary Sources:** Almonds, spinach, black beans, and dark chocolate.

**Possibility 2: Potassium Deficiency**
- **Analysis:** Potassium helps conduct electrical signals in the body. Rapid loss (e.g., through sweating) often causes acute cramping.
- **Dietary Sources:** Bananas, sweet potatoes, and avocados.

**Possibility 3: Calcium & Vitamin D Imbalance**
- **Analysis:** Calcium is needed for muscle contraction, and Vitamin D is essential for calcium absorption. 
- **Dietary Sources:** Dairy products, leafy greens, and fortified plant milks.

*Note: Standard dehydration is the #1 cause of muscle cramps. Ensure you are adequately hydrated first!*`;
        }

        if (lowercaseInput.includes('hair') || lowercaseInput.includes('nail') || lowercaseInput.includes('skin')) {
            return userContext + `Structural issues with hair, skin, and nails often overlap. Here are the primary suspects:

**Possibility 1: Biotin (Vitamin B7) Deficiency**
- **Analysis:** Biotin is essential for the production of keratin, the fundamental protein that makes up your hair, skin, and nails.
- **Dietary Sources:** Eggs (especially the yolk), organ meats, and nuts.

**Possibility 2: Iron Deficiency**
- **Analysis:** Hair thinning and spoon-shaped nails are classic signs of anemia, as hair follicles don't receive enough oxygenated blood.
- **Dietary Sources:** Iron-rich foods paired with Vitamin C (to boost absorption).

**Possibility 3: Vitamin E & Omega-3 Deficiencies**
- **Analysis:** If the primary symptom is excessively dry or flaky skin, you might lack these crucial fats and antioxidants.
- **Dietary Sources:** Fatty fish, walnuts, flaxseeds, and sunflower seeds.`;
        }
        
        // Default response
        return userContext + `That's interesting. Because symptoms rarely point to just one issue, I can provide a multi-diagnosis breakdown of potential nutritional gaps. 
